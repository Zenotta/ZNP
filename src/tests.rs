...
async fn create_block_with_seed() {
    ...
    let expected_seed1 = Some("35196964057275753190879449483539381957028274143924349513228903364529610805237-1897631206111083171268349873013649529415166812324118509467836898541232259015814296749070867098335271861351117394840902754476808231748812035257917488679002982");
...
async fn reject_receipt_based_payment() {
    ...
    let tx_hash = "gfab1a1bc7a0620d19475ea557ece0ac";
